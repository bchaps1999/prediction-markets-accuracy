...
# Functions to calculate prediction accuracy over time
...
# Changes in prediction accuracy over time

predictions_over_time <- tibble(days_before = c(1:50)) %>%
  mutate(
...
predictions_over_time %>%
  ...
  scale_color_discrete(labels = c("Polling Average", "Prediction Market Price")) +
